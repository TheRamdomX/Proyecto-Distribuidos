...
# Generar cuadrantes (en coordenadas lat/lng)
...
# Inicio y configuracion del driver de Selenium
def iniciar_driver():
    opciones = Options()
...
# Extraer pixeles de los marcadores
...
# Convertir pixeles a coordenadas lat/lng
def convertir_pixeles(x, y, lat_center, lng_center):
...
# Determinar el tipo de evento segun la clase del marcador
        ...
        for i in range(len(marcadores)):
            try:
                ...
                if x is not None and y is not None:
                    lat_event, lng_event = convertir_pixeles(x, y, lat_center, lng_center)
...
# Hilo de trabajo para procesar cuadrantes
